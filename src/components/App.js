...
class App extends Component {
    ...
    render() {
        const { ingredientsModalOpen, foodModalOpen, loadingFood, food } = this.state
        const { calendar, selectRecipe, onRemove } = this.props
                  ...
                  <li key={meal} className='meal'>
                    {meals[meal]
                      ? <div className='food-item'>
                          ...
                          <button onClick={() => onRemove({meal, day})}>Clear</button>
                        </div>
